return Def.ActorFrame {
	...
	Def.ActorFrame {
		...
		LoadFont( "_sf sports night ns upright 26px header text" ) .. {
			InitCommand=cmd(x,64;y,-7;halign,0;shadowlength,0;settext,ScreenString("HeaderText");skewx,-0.15;zoomx,1.2;maxwidth,250;);
		...
		LoadFont( "_venacti 10px header subtext" ) .. {
			InitCommand=cmd(x,64;y,11;halign,0;shadowlength,0;settext,ScreenString("HeaderSubText");zoomx,1.2;);
